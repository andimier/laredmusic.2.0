<?php
    $portfolio_data = array(
		array(
			"cliente"=> "Ricardo Arjona",
			"alt"=> "Ricardo Arjona - Blanco",
			"src"=> "diseno/clientes/ricardo-arjona-blanco.jpg"
		),
		array(
			"cliente"=> "mana & sebastian yatra",
			"alt"=> "mana & sebastian yatra - no ha parado de llover",
			"src"=> "diseno/clientes/mana-sebastian-yatra-no-ha-parado-de-llover.png"
		),
		array(
			"cliente"=> "noel schajris",
			"alt"=> "noel schajris lo mejor de mi",
			"src"=> "diseno/clientes/noel-schajris-lo-mejor-de-mi.jpg"
		),
		array(
			"cliente"=> "Maná",
			"alt"=> "Ironía - Maná",
